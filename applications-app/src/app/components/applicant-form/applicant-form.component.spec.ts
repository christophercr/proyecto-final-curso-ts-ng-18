...
fdescribe('Suite of tests on applicant-form.component (applicantForm)', () => {
  ...
  beforeEach(async () => {
    const applicationServiceMock = jasmine.createSpyObj('ApplicationsService', ['createApplicant']);
  ...
  describe('inputs:', () => {
    describe('dado el input "name"', () => {
      it('The input box must show a given name', () => {
        ...
        const inputBox = compiledHtml.querySelector('[data-test="field-name"]') as HTMLInputElement;
